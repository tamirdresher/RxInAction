...
namespace PeriodicAndTimeBasedObservables
{
    class Program
    {
        ...
        private static void ChangingTheUnderlyingObservableByTime()
        {
            ...
            IObservable<Timestamped<string>> switchingObservable =
                immediateObservable
        ...
        private static void UsingTimerToScheduleWithRelativeTime()
        {
            ...
            IObservable<Timestamped<long>> observable = Observable
        ...
        private static void UsingTimerToScheduleWithAbsoluteTime()
        {
            ...
            DateTimeOffset dateTimeOffset = DateTimeOffset.UtcNow + TimeSpan.FromSeconds(5);

            Console.WriteLine("Scheduling to {0}", dateTimeOffset);
            IObservable<Timestamped<long>> observable = Observable.Timer(dateTimeOffset)
                .Timestamp();
